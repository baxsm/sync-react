                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="text-container last">
                                    ...
                                    <p>By visiting Sync or using the Services you agree to the use of cookies in your browser and HTML-based emails. The Services you consent and use of your basic and confidential <a>Personal Information</a></p>
                                </div>
                            </div>
                            <div className="col-md-6">
                                <div className="form-container">
                                    <form id="privacyForm" data-toggle="validator" data-focus="false">
                                        <div className="form-group">
                                            <input type="text" className="form-control-input" id="pname" required />
                                            <label className="label-control" htmlFor="pname">Name</label>
                                            <div className="help-block with-errors"></div>
                                        </div>
                                        <div className="form-group">
                                            <input type="email" className="form-control-input" id="pemail" required />
                                            <label className="label-control" htmlFor="pemail">Email</label>
                                            <div className="help-block with-errors"></div>
                                        </div>
                                        <div className="form-group">
                                            <select className="form-control-select" id="pselect" required defaultValue={""}>
                                                <option className="select-option" value="" disabled>Select Option</option>
                                        ...
                                        <div className="form-group checkbox p-small">
