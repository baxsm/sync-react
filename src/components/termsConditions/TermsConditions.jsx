                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="text-container dark">
                            ...
                            <p>When you first register for a Sync account, and when you use the we collect some <a>Personal Information</a> about you such as:</p>
                            <ul className="list-unstyled li-space-lg">
                                ...
                                <li className="media">
                                    <i className="fas fa-square"></i>
                                    <div className="media-body">A unique Sync user ID (an alphanumeric string) which is assigned to you upon registration and session</div>
                                </li>
                                <li className="media">
                                    <i className="fas fa-square"></i>
                        ...
                        <div className="text-container last">
                            ...
                            <p>Sync Landing Page uses tracking technology on the landing page, in the Applications, and in the Platforms, including mobile application identifiers and a unique Hootsuite user ID to help us recognize you across different Services, to monitor usage and web traffic routing for the Services, and to customize and improve the Services. By visiting Sync or using the Services you agree to the use of cookies in your browser and HTML-based emails. Cookies are small text files placed on your device when you visit a <a>web site</a> in order to track use of the site and to improve your user experience.</p>
